            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              {data.wholesalers.map((w: any) => (
                <motion.div
                  key={w.id}
                  whileHover={{ y: -2 }}
                  className="bg-[#1a1a1d] rounded-2xl p-4 shadow-sm shadow-black/20 border border-[#2a2a2d] hover:shadow-md transition-all"
                >
                  <div className="flex items-start justify-between mb-2">
                    <h4 className="font-semibold text-gray-100 text-sm leading-tight">{w.name}</h4>
