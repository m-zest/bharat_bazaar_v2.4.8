...
const NOTIFICATIONS: Notification[] = [
  {
    ...
    time: '10 min ago', read: false, icon: Truck, color: 'text-blue-600', bg: 'bg-blue-50',
  ...
  },
  {
    ...
    time: '25 min ago', read: false, icon: TrendingDown, color: 'text-red-600', bg: 'bg-red-50',
  ...
  },
  {
    ...
    time: '1 hour ago', read: false, icon: AlertTriangle, color: 'text-amber-600', bg: 'bg-amber-50',
  ...
  },
  {
    ...
    time: '2 hours ago', read: false, icon: Zap, color: 'text-purple-600', bg: 'bg-purple-50',
  ...
  },
  {
    ...
    time: '3 hours ago', read: true, icon: CheckCircle2, color: 'text-green-600', bg: 'bg-green-50',
  ...
  },
  {
    ...
    time: '5 hours ago', read: true, icon: Star, color: 'text-orange-600', bg: 'bg-orange-50',
  ...
  },
  {
    ...
    time: 'Yesterday', read: true, icon: Package, color: 'text-green-600', bg: 'bg-green-50',
  },
  {
    ...
    time: 'Yesterday', read: true, icon: IndianRupee, color: 'text-slate-600', bg: 'bg-slate-50',
  ...
  },
  {
    ...
    time: '2 days ago', read: true, icon: CheckCircle2, color: 'text-green-600', bg: 'bg-green-50',
  },
  {
    ...
    time: '3 days ago', read: true, icon: ShoppingCart, color: 'text-blue-600', bg: 'bg-blue-50',
    action: 'View Order', actionLink: '/orders',
  },
]
    ...
    <div className="p-6 lg:p-8 max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-500 text-sm">Stay updated with your store activity</p>
        </div>
        {unreadCount > 0 && (
          <button
            onClick={markAllRead}
            className="flex items-center gap-1.5 px-4 py-2 text-sm text-orange-600 hover:bg-orange-50 rounded-lg transition-colors font-medium"
          >
          ...
          {filtered.map((notification, i) => (
            <motion.div
              ...
              className={`bg-white rounded-xl border p-4 transition-all ${
                notification.read ? 'border-slate-200' : 'border-orange-200 bg-orange-50/30'
              }`}
            >
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <h3 className={`text-sm font-semibold ${notification.read ? 'text-slate-700' : 'text-slate-800'}`}>
                      {notification.title}
                    </h3>
                    {!notification.read && (
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    {notification.action && (
                      <a
                        ...
                        className="text-[10px] text-orange-600 font-semibold hover:text-orange-700"
                      >
                        {notification.action} →
                      </a>
                    )}
